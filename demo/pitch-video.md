...
| 0:55–1:30 | Architecture shock | Architecture diagram + membrane | Agentic Depth + Differentiation |
| 1:30–3:30 | **LIVE DEMO (centerpiece)** | Terminal + ops-center + sealed app | **Demo (17) + Agentic (15)** |
...
## 3 · Architecture shock — 0:55–1:30
**ON SCREEN:** Architecture diagram (the two-network air-gap topology + the 6 layers). Animate it building up if you can.
**VO:**
...
> Everything coming back hits an **adversarial membrane** — it hunts prompt-injection, sanitizes, and only then signs the brief. Six layers, one audited door.
> *That membrane is why a regulated firm can actually trust what comes back* — and it's the part nobody else has."

---

## 4 · LIVE DEMO (the centerpiece) — 1:30–3:30
> Keep VO light here; let the screen carry it. Lower-third caption for each beat.
...
**ON SCREEN:** dispatch a nonsense target → `inconclusive`, confidence `0`.
**VO:**
...
## 5 · Why we win — 3:30–4:15
**ON SCREEN:** Market slide → Business model → **Competition matrix** (linger on the "Web-search APIs" column).
**VO:**
> "Alternative data is a **$17.78 billion market growing 52% a year**. Funds already pay **$1.6M a year** for fixed feeds — we're the **on-demand layer for the questions those feeds can't answer**. €2,500 a seat, then metered usage, and every search makes the next one cheaper.
...
# Real query:  "Has Live Nation suffered a data breach?"  (target_entity: Live Nation)
# Nonsense target → inconclusive @ 0
# Buttons: TAMPER  ·  VERIFY A BRIEF drop-zone  ·  Deliverables: xlsx / stix
```
...
~470 words of VO ≈ 3:10 of speech at 150 wpm + ~60–90s of demo visual pauses = **~4:15–4:45**. If you run long, cut from §3 (architecture) and §5 (why-we-win), never from the demo.
